...
public class MainTest {
    ...
    public void testCalc(){
        ...
        item.setResult();
        assertEquals("Expected:" + item + "\nbut was: ", item, calc.getItems().get(calc.getItems().size() - 1));
        calc.viewInit(10000222212232L);
        item.setNumber(10000222212232L);
        item.setResult();
        assertEquals("Expected:" + item + "\nbut was: ", item, calc.getItems().get(calc.getItems().size() - 1));
        calc.viewInit(999999122L);
        item.setNumber(999999122L);
        item.setResult();
        assertEquals("Expected:" + item + "\nbut was: ", item, calc.getItems().get(calc.getItems().size() - 1));
    }
    ...
    public void testRestore(){
        ...
        assertEquals("containsAll()", view1.getItems().get(0).toString(), view2.getItems().get(0).toString());
